...
def create_app():
    ...
    CORS(
        ...
        resources={
            r"/api/*": {
                "origins": ["http://localhost:5173", "http://localhost:5174", "https://meallens-ai.vercel.app", "https://meallensai.com", "https://meallens-ai.netlify.app", "https://meallens-ai-cmps.onrender.com"],
